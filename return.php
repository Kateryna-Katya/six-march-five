...
<main>
    <section class="pages">
        <div class="container">
            ...
            <p>
                Мы стремимся обеспечить высокое качество обучения в <strong><?= $domainTitle ?></strong>. 
            ...
            <ul>
                <li>
                    ...
                    предоставленного учебного курса или практических материалов существенно отличается от программы,
                ...
                <li>
                    ...
                    <strong><?= $fullDomain ?></strong>, которые делают доступ к лекциям или AI-инструментам невозможным и не были
                ...
                <li>
                    ...
                    дней с момента оплаты, при условии, что вы еще не начали активное обучение (см. раздел «Исключения»).
                </li>
            </ul>
            ...
            <ol>
                ...
                <li>
                    В теме письма обязательно укажите: «Запрос на возврат средств — [Ваше Имя]».
                </li>
                <li>
                    В теле письма предоставьте полную информацию: ваше имя и фамилию,
                    email, который использовался при регистрации в IT-школе, и название курса.
                </li>
                <li>
                ...
                <li>
                    Наша служба поддержки рассмотрит ваш запрос и свяжется с вами для 
                    предоставления решения в течение 3-х рабочих дней.
                </li>
            </ol>
            ...
            <p>
                ...
                зависит от регламента работы вашего банка в <strong>Италии</strong> или стране выпуска вашей карты.
            </p>
            ...
            <ul>
                <li>
                    Запрос подан по истечении 14 календарных дней с момента совершения платежа.
                </li>
                <li>
                    Вы уже изучили или скачали более 50% материалов учебной программы, независимо
                    от времени, прошедшего с момента покупки.
                </li>
                <li>
                    Причиной невозможности пройти обучение являются технические
                    проблемы на стороне пользователя (проблемы с интернет-соединением, несовместимость личного ПО).
                </li>
                <li>
                    Были нарушены правила использования платформы <strong><?= $domainTitle ?></strong> или нормы 
                    Пользовательского соглашения с вашей стороны.
                </li>
            </ul>
            ...
            <p>
                ...
                Политику возврата в соответствии с требованиями законодательства ЕС. Актуальная версия всегда доступна на 
                этой странице: <strong><?= $fullDomain ?></strong>.
            </p>

            <h2>Свяжитесь с нами</h2>
            <p>
                По всем вопросам, связанным с возвратом средств или условиями доступа к программам, 
                пожалуйста, обращайтесь в нашу экспертную службу поддержки:
                <br><br>
                Email: <a href="mailto:support@<?= $fullDomain ?>">support@<?= $fullDomain ?></a><br>
                Телефон: <a href="tel:+390697638629">+39 06 9763 8629</a>
            </p>
            
            <div class="pages-footer" style="margin-top: 50px; padding-top: 30px; border-top: 1px solid rgba(0,0,0,0.05);">
                <p style="font-size: 0.9rem; opacity: 0.7;">Последнее обновление: Март 2026. Платформа доступна в Европе.</p>
            </div>
        </div>
    </section>
</main>
